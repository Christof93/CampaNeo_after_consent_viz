...
\begin{document}
  The goal of this project in terms of implementation was to
  ...
  a necessity. A great fit in this regard is RDF4j. RDF4j, a native triple
  ...
  to visualize the consent page as shown in \autoref{fig:prototype}.
\end{document}
